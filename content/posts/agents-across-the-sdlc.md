...
The first is reactive: read the corrections and the failures, and turn them into a pull request waiting for you in the morning; new wording for an agent's prompt, a tool added or removed, a base instruction sharpened.
...
So: agents improve the software; the Improver improves the pipeline.
