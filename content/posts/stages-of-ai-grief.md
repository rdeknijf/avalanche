...
And maybe, just maybe, I was made to do this more than actual programming. I'm pretty good at exactly the level of idea-having and directing that is now required to get these things moving. And I've got a few decades of doing IT to draw upon to verify that it keeps making sense. So I keep [upgrading the system](/posts/make-every-problem-claudes-problem/); now I'm making the AI look at my own sessions and find corrections, and correct the instructions for next time. And this works really well!
